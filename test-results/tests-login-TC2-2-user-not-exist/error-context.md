...
- Name: TC2-2: user not exist
- Location: /Users/winithraks/Desktop/Game-Shelf/tests/login.spec.ts:18:5
...
Call log:
  ...
  - waiting for getByText('Incorrect password or email')
    ...
    at /Users/winithraks/Desktop/Game-Shelf/tests/login.spec.ts:29:65
```
...
- main:
  ...
  - paragraph:
    ...
    - link "Create an account":
      - /url: /sign-up
  - textbox "Email Address": player123@gmail.com
