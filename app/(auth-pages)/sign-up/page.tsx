...
import { signUpAction, checkUsernameUnique, checkEmailUnique } from "../actions"; 
    ...
    <div className="flex justify-center items-center">
      ...
      <div className="flex flex-1 justify-center items-center  text-white p-8">
        <div className="text-center space-y-6">
          <img
            src={isProvider === null ? "/mock_user.jpeg" : isProvider === true ? "/mock_provider.jpeg" : "/mock_player.jpg"} // Replace with your image path
            alt="Signup Illustration"
            className="max-w-md mx-auto"
          />
          <h1 className="text-4xl font-bold">
            {isProvider === null ? "Welcome" : isProvider === true ? "Provider" : "Player"}
          </h1>
          <p className="text-lg">
          ...
          <div className="card-body gap-7">
            <div className="flex flex-col gap-3">
              ...
              <p className="text-sm text text-foreground">
                ...
                <Link className="text-gs_purple font-medium hover:text-gs_white" href="/sign-in">
                  Sign in
                </Link>
              </p>
            </div>

            <form className="flex flex-col min-w-64 gap-7 placeholder:text-gs_white" onSubmit={handleSubmit}>
