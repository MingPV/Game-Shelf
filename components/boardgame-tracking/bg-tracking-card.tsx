...
export default function BoardGameCard({name, picture, price, description, status}:
    ...
    return (
        <div className={`card card-side shadow-xl border-white border-[1px] m-5 relative transition-all duration-300 ${showProgess ? 'h-[350px]' : 'h-[250px]'}`}>
            <img
                src={picture}
            ...
            <div className="card-body flex flex-col">
                ...
                <div>
                    ...
                    <div className="flex justify-end">
                        <button className="bg-emerald-600 rounded px-5 py-2 hover:bg-emerald-700">edit condition or details</button>
                    </div>
                </div>
                {showProgess && (
