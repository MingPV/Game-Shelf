...
export default function Profile({user}:{user:UserData}){
    ...
    const [img, setImg] = useState<string>(user.profilePicture? user.profilePicture: "https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.webp");
    ...
    const handleClickUpdate = (e: React.ChangeEvent<HTMLInputElement>) => {
        ...
        Swal.fire({
          ...
          if (result.isConfirmed) {
            ...
            setImg(user.profilePicture? user.profilePicture: "https://img.daisyui.com/images/stock/photo-1534528741775-53994a69daeb.webp");
          }
        });
      };
        ...
        <>
            <div className="flex flex-col items-center">
                <label className="cursor-pointer">
                    <input type="file" accept="image/*" onChange={handleClickUpdate} className="hidden" />
                    <img
                    src={img}
                    alt="profile picture"
