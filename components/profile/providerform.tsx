    ...
    <>
      ...
      <div className="flex justify-between items-center w-full">
        ...
        <div className="grid grid-cols-10 gap-5">
            <Label htmlFor="id" className="font-bold text-md col-span-4">
                ID :
            </Label>
            <Input
                name="id"
                ...
                disabled
            />
            <Label htmlFor="username" className="font-bold text-md col-span-4">
                Username :
            </Label>
            <Input
                name="username"
            ...
            <Label htmlFor="email" className="font-bold text-md col-span-4">
                E-mail :
            </Label>
            <Input
                name="email"
                ...
                disabled
            />
            <Label htmlFor="phoneNumber" className="font-bold text-md col-span-4">
                Phone Number :
            </Label>
            <Input
                name="phoneNumber"
                ...
                className="bg-gs_white bg-opacity-10 col-span-6 border-white border-opacity-60"
            />
            <Label htmlFor="location" className="font-bold text-md col-span-4">
                Location : 
            </Label>
            <textarea
                name="location"
            ...
            />
            <Label htmlFor="credentials" className="font-bold text-md col-span-4">
                Credentials :
            </Label>
            <Input
                name="credentials"
        ...
        <div className="items-center justify-center flex flex-row">
            <button className="btn bg-white bg-opacity-10 border-white border-opacity-80 border-1 mr-5 md:mr-7 mt-5 px-10" onClick={handleClickCancel}>Cancel</button>
            <button className="btn bg-white bg-opacity-10 border-white border-opacity-80 border-1 ml-5 md:ml-7 mt-5 px-10" onClick={handleClickUpdate}>Update</button>
        </div>
      </div>
