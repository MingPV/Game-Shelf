...
export default function VerificationButton({provider_id} : {provider_id: string}) {
    ...
    <div>
        ...
        { (sentVerifyReq === "") && 
            <div className="flex flex-col items-center">
                ...
                <div className="font-normal text-gray-400 pt-2">If you have already submitted the form.</div>
                <div className="font-normal text-gray-400">Try refreshing the page.</div>
            </div> 
        }
    </div>
  );
