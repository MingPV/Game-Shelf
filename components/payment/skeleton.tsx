      ...
      >
        ...
        <div className="card-body flex flex-col p-2 md:p-4 md:col-span-2 m-4">
          ...
          <div className="grid grid-cols-6 gap-2">
                <p className="font-bold col-span-3 md:col-span-2 flex items-center opacity-0">provider:</p>
                <p className="col-span-3 md:col-span-4 flex items-center opacity-0">
                    provider
                </p>

                <p className="font-bold col-span-3 md:col-span-2 flex items-center opacity-0">date:</p>
                <p className="col-span-3 md:col-span-4 flex items-center opacity-0">
                    {"formatDate(boardgameData.start_date)"} &nbsp;-&nbsp;
                    {"formatDate(boardgameData.end_date)"}
                </p>

                <p className="font-bold col-span-3 md:col-span-2 flex items-center opacity-0">price:</p>
                <p className="col-span-3 md:col-span-4 flex items-center opacity-0">
                    {"boardgameData.board_game.price"} 
                    <TbCurrencyBaht /> / day
                </p>

                <p className="font-bold col-span-3 md:col-span-2 flex opacity-0">status:</p>
