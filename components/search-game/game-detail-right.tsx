        ...
        <div className="w-1/2 flex flex-col space-y-8">
            ...
            <div className="flex text-md flex-wrap w-full gap-2">
                {boardgame.types?.map((type, index) => (
                    <div key={index} className="py-1 px-2 rounded-lg bg-gs_purple_gradient opacity-95">
            ...
            <button
                className="w-1/2 font-semibold text-sm px-4 rounded-xl py-2 self-start hover:border bg-gs_purple_gradient"
